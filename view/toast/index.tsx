    ...
    <ToastContainer
      ...
      toastClassName={({ type }: any) =>
        cn(
          ...
          'relative flex p-3 my-3 mx-3 min-h-10 rounded-md justify-between overflow-hidden cursor-pointer bg-opacity-30 backdrop-filter backdrop-blur-md border border-white/10 z-90',
        )
      }
